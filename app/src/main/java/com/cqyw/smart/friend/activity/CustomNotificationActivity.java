...
import com.cqyw.smart.friend.helper.CustomNotificationCache;
import com.cqyw.smart.friend.viewholder.CustomNotificationViewHolder;
 ...
 */
public class CustomNotificationActivity extends JActionBarActivity implements TAdapterDelegate {
    ...
    private int sendTarget = -1; // 0 濂藉弸 1 缇?
    ...
    private void selectCustomNotificationTarget(boolean team) {
        ...
        option.title = AppCache.getContext().getString(R.string.select_custom_notification_target);
        option.multi = false;
    ...
    private void sendCustomNotification(String account, String content) {
        ...
        notification.setFromAccount(AppCache.getJoyId());
