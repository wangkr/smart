...
import com.cqyw.smart.friend.activity.MultiportActivity;
...
public class SessionListFragment extends FriendTabFragment {
    ...
    public SessionListFragment() {
        this.setContainerId(FriendTab.RECENT_CONTACTS.fragmentId);
    }
        ...
        contactsFragment.setCallback(new RecentContactsCallback() {
            ...
            public String getDigestOfAttachment(MsgAttachment attachment) {
                ...
                if (attachment instanceof StickerAttachment) {
                    return "[贴图]";
                } else if (attachment instanceof MySnapChatAttachment) {
                    return "[阅后即焚]";
                }
                return null;
            }
