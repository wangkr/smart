...
public class RecentCommentViewHolder extends RecentViewHolderBase {
    ...
    protected void bindContentView() {
        setNickName();
        msgType_tv.setText("回复:");
        msgType_tv.setTextColor(context.getResources().getColor(R.color.recentnews_msgType_comment));
        if (TextUtils.isEmpty(message.getContent())) {
            ...
            content_tv.setText(StringUtil.removeFirstBracket(content_str,'[', ']'));
