...
package com.cqyw.smart.widget.viewpaper;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    // @formatter:on
    private RelativeLayout actionbarTabLayout = null;
    ...
    private int underlineColor = getResources().getColor(R.color.theme_color);

    private int dividerColor = 0x00000000;

    private int checkedTextColor = 0;

    private int unCheckedTextColor = 0;
    ...
    // 添加actionBar TabView 联动
    public void attachActionbarTabview(RelativeLayout tabLayout){
        actionbarTabLayout = tabLayout;// Kyrong
    }
    ...
    public void onPageSelected(int position) {
        ...
        scrollToActionBarTabview(position); // Kyrong
    }
    ...
    public void notifyDataSetChanged() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollToActionBarTabview(currentPosition); // Kyrong
    ...
    private void scrollToActionBarTabview(int position){
        ...
        if( position == 0){
            ...
            actionbarTabLayout.findViewById(R.id.friend_tab_contact).setBackgroundResource(R.drawable.right_rounded_bg);
            ((TextView)actionbarTabLayout.findViewById(R.id.friend_tab_session)).setTextColor(getResources().getColor(checkedTextColor));
            ((TextView)actionbarTabLayout.findViewById(R.id.friend_tab_contact)).setTextColor(getResources().getColor(unCheckedTextColor));
        } else if(position == 1){
            actionbarTabLayout.findViewById(R.id.friend_tab_session).setBackgroundResource(R.drawable.left_rounded_bg);
            actionbarTabLayout.findViewById(R.id.friend_tab_contact).setBackgroundColor(Color.TRANSPARENT);
            ((TextView)actionbarTabLayout.findViewById(R.id.friend_tab_session)).setTextColor(getResources().getColor(unCheckedTextColor));
            ((TextView)actionbarTabLayout.findViewById(R.id.friend_tab_contact)).setTextColor(getResources().getColor(checkedTextColor));
        }
    }
    ...
    private void addTabView(final int position, String title) {
        ...
        if (tabView == null) {
            tabView = inflater.inflate(R.layout.friend_tab_title_item, null);
        }
...
//        }
    ...
    public void updateTab(int index, ReminderItem item) {
        ...
        TextView unreadLbl = null;
//        ImageView indicatorView = (ImageView) tabView.findViewById(R.id.tab_new_indicator);
        if(actionbarTabLayout != null){
            if(index == 0) {
                unreadLbl = (TextView) actionbarTabLayout.findViewById(R.id.tab_new_msg_label); // Kyrong
            } else if(index == 1){
                unreadLbl = (TextView) actionbarTabLayout.findViewById(R.id.tab_new_friend_label);// Kyrong
            }
        }
