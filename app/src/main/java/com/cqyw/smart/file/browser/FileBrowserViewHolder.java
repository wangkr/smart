...
import com.cqyw.smart.file.browser.FileBrowserAdapter.FileManagerItem;
...
public class FileBrowserViewHolder extends TViewHolder{
    ...
    protected void inflate() {
        directoryBitmap = BitmapFactory.decodeResource(AppCache.getContext().getResources(),R.drawable.directory);
        fileBitmap = BitmapFactory.decodeResource(AppCache.getContext().getResources(), R.drawable.file);
