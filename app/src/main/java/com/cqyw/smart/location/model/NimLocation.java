package com.cqyw.smart.location.model;
...
public class NimLocation {
	...
	public static final String BDMap_Location = "BDMap_location";
	...
	public double getLatitude() {
		if (location != null) {
			if (type.equals(BDMap_Location))
				latitude = ((BDLocation) location).getLatitude();
	...
	public double getLongitude() {
		if (location != null) {
			if (type.equals(BDMap_Location))
				longitude = ((BDLocation) location).getLongitude();
			else if (type.equals(System_Location))
