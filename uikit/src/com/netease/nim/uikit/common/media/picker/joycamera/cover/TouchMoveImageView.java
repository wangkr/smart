package com.netease.nim.uikit.common.media.picker.joycamera.cover;
...
import com.netease.nim.uikit.common.media.picker.joycamera.blur.FastBlur;
            ...
            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_MOVE:
                    if (mode == ZOOM) {
                        ...
                        //ScreenUtil.screenWidth  为裁剪区域宽高，正方形
                        //平移时分别判断x、y轴坐标是否符合要求，不能在 (0,ScreenUtil.screenWidth)之间
                ...
                case MotionEvent.ACTION_POINTER_UP:
                    if (mode == ZOOM && matrixZoomCheck) {
                        ...
                        } else if (x3 > 0 && y3 < ScreenUtil.screenWidth) {
                            matrixZoom.postTranslate(0 - x3, ScreenUtil.screenWidth - y3);// 平移
                        } else if (x1 > 0 && y1 < 0 && y3 > ScreenUtil.screenWidth) {
                            matrixZoom.postTranslate(0 - x1, 0);// 平移
                        } else if (x1 < 0 && y1 > 0 && x2 > ScreenUtil.screenWidth) {
                            matrixZoom.postTranslate(0, 0 - y1);// 平移
                        } else if (x2 < ScreenUtil.screenWidth && y2 > 0) {
                            matrixZoom.postTranslate(ScreenUtil.screenWidth - x2, 0 - y2);// 平移
                        } else if (x2 < ScreenUtil.screenWidth && y2 < 0 && y4 > ScreenUtil.screenWidth) {
                            matrixZoom.postTranslate(ScreenUtil.screenWidth - x2, 0);// 平移
                        } else if (x4 < ScreenUtil.screenWidth && y4 < ScreenUtil.screenWidth) {
                            matrixZoom.postTranslate(ScreenUtil.screenWidth - x4, ScreenUtil.screenWidth - y4);// 平移
                        } else if (x4 > ScreenUtil.screenWidth && y4 < ScreenUtil.screenWidth && x3 < ScreenUtil.screenWidth) {
                            matrixZoom.postTranslate(0, ScreenUtil.screenWidth - y4);// 平移
                        }
                        matrix.set(matrixZoom);
                        invalidate();
                    }
