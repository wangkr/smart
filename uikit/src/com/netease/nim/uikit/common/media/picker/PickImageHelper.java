...
import com.netease.nim.uikit.joycustom.JoyPictureOptionDialog;
...
public class PickImageHelper {
     ...
     * @param option
     */
    public static void myPickImage(final Context context, final int requestCode, final PickImageOption option) {
        if (context == null) {
            return;
        }

        JoyPictureOptionDialog dialog = new JoyPictureOptionDialog(context,R.style.picture_optDialog_style);
        dialog.setCamOptListener(new View.OnClickListener() {
            @Override
        ...
        dialog.setGalOptListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
