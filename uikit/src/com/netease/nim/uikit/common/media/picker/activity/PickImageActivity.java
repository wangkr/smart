...
public class PickImageActivity extends TActionBarActivity {
    ...
    private String pathFromResult(Intent data) {
        String outPath = getIntent().getStringExtra(Extras.EXTRA_FILE_PATH);
        LogUtil.d(TAG, "pathFromResult="+outPath);
        ...
        try {
            ...
            if (crop) {
                ...
                if (!TextUtils.isEmpty(photoPath)) {
                    ...
                    LogUtil.d(TAG, "onPickedCamera photoPath=" + photoPath);
                    result.putExtra(Extras.EXTRA_FILE_PATH, photoPath);
                    setResult(RESULT_OK, result);
                    LogUtil.d(TAG, "onPickedCamera");
                }
                finish();
            }
        } catch (Exception e) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_CODE_LOCAL:
                ...
                LogUtil.d(TAG, "request_code_local");
                break;
