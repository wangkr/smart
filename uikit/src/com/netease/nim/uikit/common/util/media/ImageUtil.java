...
public class ImageUtil {
    ...
    public static String makeThumbnail(Context context, File imageFile, int dstMaxWH, int dstMinWH) {
    ...
    public static File getScaledImageFileWithMD5(File imageFile, String mimeType) {
        ...
        if (ImageUtil.scaleImage(imageFile, tempImageFile, maxWidth, compressFormat, quality)) {
            LogUtil.d("ImageUtil", "tempImageFile="+tempImageFile==null?"false":"true");
    ...
    public static Bitmap getScreenFitBitmap(File srcFile) {
        ...
        Bitmap dstBitmap = null, srcBitmap;
    ...
    public static CompressFormat getBitmapScaleFormat(String mimeType) {
        String lowerCaseFilepath = mimeType.toLowerCase();
        if (lowerCaseFilepath.contains("jpg") || lowerCaseFilepath.contains("jpeg")) {
            return CompressFormat.JPEG;
        } else if (lowerCaseFilepath.contains("png")) {
