...
public class HeadImageView extends ImageView {
    ...
    public void loadBuddyAvatar(String account) {
        loadBuddyAvatar(account, JoyImageUtil.ImageType.V_120);
    }
...
//        }
     ...
     * @param type 缩略图的种类
     */
    public void loadBuddyAvatar(String account, JoyImageUtil.ImageType type) {
        initMask(type);// Kyrong
        ...
        if (userInfo != null/* && ImageLoaderKit.isImageUriValid(userInfo.getAvatar())*/) {
             ...
             */
            JoyImageUtil.bindHeadImageView(this, userInfo.getAvatar(), type, options);
        } else {
