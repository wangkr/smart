...
- 聊天窗口背景。优先使用 uri，如果没有提供 uri，使用 color。如果没有 color，使用默认。uri 暂时支持以下格式：
  ...
  assets: com.cqyw.smart.file:///android_asset/{asset文件路径}
  com.cqyw.smart.file: com.cqyw.smart.file:///文件绝对路径
...
private static SessionCustomization getMyP2pCustomization() {
    ...
    private static SessionCustomization initBaseP2P() {
        ...
        p2pCustomization.backgroundUri = "com.cqyw.smart.file:///android_asset/xx/bk.jpg";
        p2pCustomization.backgroundUri = "com.cqyw.smart.file:///sdcard/Pictures/bk.png";
